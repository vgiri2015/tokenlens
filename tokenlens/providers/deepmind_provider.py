...
class DeepMindProvider(ProviderTemplate):
    def __init__(self):
        super().__init__()
        self.provider_name = "deepmind"
        
    def check_text_limits(self, text: str, model: str) -> Dict[str, Any]:
        """Check text limits for DeepMind models."""
    ...
    def list_models(self) -> Dict[str, Any]:
        """List available DeepMind models."""
        return {
            "text_models": ["flamingo"],
            "provider": self.provider_name
        }
